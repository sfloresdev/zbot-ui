...
>
    <Card.Root
        class="relative w-full min-h-[460px] flex flex-col justify-center rounded-none border border-white/20 bg-black shadow-2xl z-20 cyber-card-fade"
    >
        ...
        <Card.Content class="px-8 pb-12 sm:px-12 md:px-16">
            <form onsubmit={handleLogin} class="space-y-5">
                {#if errorMessage}
                    <p
                        class="text-xs font-bold uppercase text-red-500 tracking-widest text-center"
                    >
                        {errorMessage}
                    </p>
                {/if}
                ...
                <div class="space-y-6">
                    ...
                    <div class="space-y-2">
                        ...
                        <div class="pt-1 text-left ml-1">
                            <a
                                href="/recover"
                                class="text-[10px] font-bold uppercase tracking-widest underline decoration-white/30 hover:decoration-white text-white/70 transition-colors"
                            >
